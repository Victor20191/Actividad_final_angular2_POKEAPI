import { ChangeDetectionStrategy, Component, OnDestroy, Input, OnInit, computed, effect, signal } from '@angular/core';
...
export default class AnimationComponent implements OnInit, OnDestroy {
  @Input() set pokemonId(value: number | null) {
    if (value) {
      this.pokemonNameOrId.set(value.toString());
      this.loadPokemon();
    }
  }
